...
class MessagesProvider extends ChangeNotifier {
  ...
  Future<void> loadMessages(int circleId, {int? cursor}) async {
    ...
    try {
      ...
      fetchedMessages.sort((a, b) => a.createdAt.compareTo(b.createdAt)); // Ensure messages are sorted by creation time
      ...
      if (cursor == null) {
        ...
        _messages.sort((a, b) => a.createdAt.compareTo(b.createdAt)); // Re-sort after adding new messages
      }
 ...
 // Listen for socket events
  ...
  // Listen for disconnects
    ...
    _socket!.on('message:new', (data) {
      ...
      final alreadyExists = _messages.any((m) => m.id == message.id); // new messages shouldn't already exist, but just in case
